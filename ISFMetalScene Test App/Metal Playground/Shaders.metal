...
textureToScreenVertexShader(uint vertexID [[ vertex_id ]],
                            constant MetalBitsTextureVertex *vertexArray [[ buffer(MetalBitsVertexInputIndexVertices) ]],
                            constant vector_uint2 *viewportSizePointer  [[ buffer(MetalBitsVertexInputIndexViewportSize) ]])
{
