...
// MODIFICATION for SPIRV: variable and function sharing a common name is forbiden. Renamed 'iGlobalTime to iGlobalTimeFn' (it's unused anyway)
float iGlobalTimeFn(float PARAM_TIME) {
