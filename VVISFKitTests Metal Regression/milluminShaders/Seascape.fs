/*
{
  "CREDIT": "Alexander Alekseev (http://www.shadertoy.com/view/Ms2SD1)",
  "INPUTS": [
    {
      "NAME": "iMouse",
      "TYPE": "point2D"
...
void main() {
    ...
    // ray
    vec3 ang = vec3(0., 0.15, 3.0-iMouse.x);
    vec3 ori = vec3(0.0, 3.5, iMouse.y*5.0+TIME*2.0);
