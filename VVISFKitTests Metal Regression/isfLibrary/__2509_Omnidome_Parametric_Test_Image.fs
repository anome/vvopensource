/*{
  "CREDIT": "by wilstonoreo, Omnidome",
  "DESCRIPTION": "Omnidome Parametric Test Image",
  "CATEGORIES": [
    "Omnidome"
  ],
  "INPUTS": [
...
void main(void)
{
  ...
  float fineGrid = clamp(4.0 - grid(vec2(90.0,90.0),0.125),0.0,4.0);
