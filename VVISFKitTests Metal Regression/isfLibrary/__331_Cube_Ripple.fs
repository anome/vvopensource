/*{
	"CREDIT": "by joshpbatty and Nico Raftis",
...
float box_size = 0.0025 + size * 0.25;
...
void main() {
    ...
    if(mirrorX == true){ vPos.x = abs(vPos.x);} // TODO make into 3d mirror
    if(mirrorY == true){ vPos.y = abs(vPos.y);}
