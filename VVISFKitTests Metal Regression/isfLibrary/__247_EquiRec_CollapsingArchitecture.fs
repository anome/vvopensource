/*{
  ...
  "DESCRIPTION" : "interactiveshaderformat.com/sketches/1615",
  "INPUTS" : [
	{
		"NAME": 	"rate",
		"TYPE": 	"float",
...
////////////////////////////////////////////////////////////
// EquiRec_CollapsingArchitecture  by mojovideotech
// 
// Equirectangular version of 
// interactiveshaderformat.com/sketches/1615
...
void main() {
    ...
    float xz = radians(360.*(gl_FragCoord.x/RENDERSIZE.x-.5));
		vec3 rd = mix(vec3(uv,FOV+warp),vec3(sin(xz)*cos(yy), sin(yy), cos(xz)*cos(yy)),1.0-warp);
    time += 2.;
    vec3 light = vec3(0, 0, time);
    time -= 2.;
