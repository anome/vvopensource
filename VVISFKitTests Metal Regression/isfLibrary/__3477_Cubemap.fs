/*{
  ...
  "DESCRIPTION" : "Single pass spherical coordinate transformation. 2:1 Equirectangular > 6:1 Cubemap Front-Back-Left-Right-Top-Bottom",
  "INPUTS" : [
    	{
      		"NAME" : "inputImage",
    		"TYPE" : "image"
...
////////////////////////////////////////////////////////////
// EquiRec2CubeMapFBLRTB  by mojovideotech
//
// Single pass spherical coordinate transformation
// Input 2:1 Equirectangular / LatLong
// Output 6:1 Cubemap Front-Back-Left-Right-Top-Bottom
// (alternate face order)
//
