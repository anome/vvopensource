/*{
    ...
    "DESCRIPTION": "Automatically converted from https://www.shadertoy.com/view/wdGXzK by BigWIngs.  Couldn't help it. This thing is insane!See code for comments.",
    "IMPORTED": {
    },
    "INPUTS": [
        {
        ...
        {
            "DEFAULT": 1.87,
            "LABEL": "Beams per second",
            "MAX": 10.0,
            "MIN": 0.0,
            "NAME": "BEAMS_PER_SECOND",
            "TYPE": "float"
        }        
    ],
    "ISFVSN": "2"
...
void main() {
	...
	vec4 m = vec4(iMouse.x,iMouse.y,iMouse.x,iMouse.y);
