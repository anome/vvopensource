...
void main()	{
    ...
    col+=IMG_NORM_PIXEL(inputImage,uv.xy*2.0-iTime*0.03).rgb;
    //col+=
   // col+=IMG_NORM_PIXEL(inputImage,gl_FragCoord.xy).rgb;
    //col+=IMG_PIXEL(inputImage, gl_FragCoord.xy).rgb;
    //col+=IMG_NORM_PIXEL(inputImage, isf_FragNormCoord.xy).rgb;
