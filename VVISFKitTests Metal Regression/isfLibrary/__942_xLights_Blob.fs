...
{
	float c1 = saturate(distance*5.0 + 0.5) - colorCycle;
	float c2 = saturate(distance*5.0) - colorCycle;
	float c3 = saturate(distance*3.4 - 0.5) - colorCycle;
