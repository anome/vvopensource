/*
{
  "CATEGORIES": ["Shadertoy", "Generator", "Raytracing"],
  "DESCRIPTION": "converted by Alexander Shvets from https://www.shadertoy.com/view/Ms2SD1",
  "IMPORTED": [],
  "INPUTS": [
    {
      "NAME": "iMouse",
    ...
    },
    {
		"NAME": "SEA_BASE",
		"TYPE": "color",
		"DEFAULT": [0.1,0.19,0.22, 1.0]
	},
	{
		"NAME": "SEA_WATER_COLOR",
		"TYPE": "color",
		"DEFAULT": [0.8,0.9,0.6, 1.0]
	},
    {
      "NAME": "SEA_FREQ",
      "MIN": 0.0,
