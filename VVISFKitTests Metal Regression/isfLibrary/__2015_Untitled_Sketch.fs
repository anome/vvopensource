/*
{
  ...
  "DESCRIPTION" : "Automatically converted from https://www.shadertoy.com/view/MtdXRS by psonice.  Initial plans didn't work out, ended up making this instead. Apologies if the wave motion causes nausea ;)",
  "INPUTS" : [
    {
      "NAME" : "iMouse",
      "TYPE" : "point2D"
...
vec3 texrand(in vec2 n, in float mipLevel) {
    return IMG_NORM_PIXEL(iChannel2,mod(n,1.0),mipLevel).xyz;
}
