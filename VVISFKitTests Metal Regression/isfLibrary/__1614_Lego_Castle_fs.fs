/*
{
  ...
  "DESCRIPTION": "Automatically converted from https://www.shadertoy.com/view/4sXGDj by Antonalog.  The original little plastic voxels, and still the best.. I would do more but shader compiler will explode!!<br/>Hah! now with Lego logo courtesy of mmalex!! <3 <3 <3",
  "IMPORTED": [
    {
      "NAME": "iChannel0",
      "PATH": [
...
{
	vec2 ooR = 1./RENDERSIZE.xy;
    vec2 q = fragCoord.xy * ooR;
    vec2 p =  2.*q -1.;
    p.x *= RENDERSIZE.x * ooR.y;
