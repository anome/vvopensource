/*
{
    ...
    "DESCRIPTION": "Automatically converted from https://www.shadertoy.com/view/MdSXzz by iq.  More fbm warping",
    "IMPORTED": {
    },
    "INPUTS": [
    ]
...
mat2 m = mat2( 0.180,  0.160, -0.160,  0.4180 );

float hash( vec2 p )
{
	float h = dot(p,vec2(127.1,321.7));
