/*
{
  ...
  "DESCRIPTION" : "Automatically converted from https://www.shadertoy.com/view/ltj3D3 by the23.  further modification of https://www.shadertoy.com/view/4lSGDc . Used iq's excellent cosine color gradient article (www.iquilezles.org/www/articles/palettes/palettes.htm).",
  "INPUTS" : [
    {
      "NAME" : "Orbrad",
      "TYPE" : "float",
...
float zoomFactor = zooom;
float orbitRadius = Orbrad;
...
void main()
{
  ...
  vec2 pos = (gl_FragCoord.xy / RENDERSIZE.xy) * vec2(aspect, 1.0);
