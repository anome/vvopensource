/*
{
  ...
  "DESCRIPTION" : "Automatically converted from https://www.shadertoy.com/view/WdsXDH by neozhaoliang.  A simple scene made with mandelbulb and sponge",
  "INPUTS" : [
...
void main() {
    ...
    for (int ii = 0; ii < AA; ii ++)
	{
	    for (int jj = 0; jj < AA; jj++)
		{
		    ...
		    vec2 uv = (gl_FragCoord.xy + offset) / RENDERSIZE.xy;
		    uv = 2.0 * uv - 1.0;
