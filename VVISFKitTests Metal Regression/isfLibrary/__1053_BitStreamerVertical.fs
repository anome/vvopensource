...
void main() {
    ...
    vec3 color = vec3(0.);
    color.r = pattern(vel,st+off1,0.5+density/RENDERSIZE.y);
    color.g = pattern(st,vel,0.5+density/RENDERSIZE.y);
    color.b = pattern(st-off2,vel,0.5+density/RENDERSIZE.y); 
