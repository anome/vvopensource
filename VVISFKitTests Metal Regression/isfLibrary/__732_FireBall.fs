/*
{
  ...
  "DESCRIPTION" : "Automatically converted from https://www.shadertoy.com/view/MtXSzS by Duke.  Fireball",
  "INPUTS" : [
    {
      "NAME" : "iMouse",
      "TYPE" : "point2D"
...
#define Radius radiusR
#define Background vec4(colorvalue)
// Noise Settings
#define NoiseSteps 1
#define NoiseAmplitude 0.06*scaleZ
