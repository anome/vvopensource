/*
{
  ...
  "DESCRIPTION" : "Automatically converted from https://www.shadertoy.com/view/wssXWl by evvvvil.  \"The gamma ray feast\" - Shader showdown practice session 011.\nLive coded on Twitch with 25 minutes time limit.\nPracticing live on TWITCH every Tuesdays around 21:00 UK time.\nhttps://www.twitch.tv/evvvvil_",
  "INPUTS" : [
...
void main() {
    ...
    gl_FragColor = vec4(pow(co,vec3(0.45)),1);//Cheap tone mapping, even cheaper than the presents your ex used to get you for christmas
}
