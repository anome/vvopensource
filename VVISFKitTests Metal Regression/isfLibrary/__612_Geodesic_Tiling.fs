/*
{
  ...
  "DESCRIPTION" : "Automatically converted from https://www.shadertoy.com/view/llVXRd by tdhooper.  Distributing points on a sphere, without the bunching at the poles you get from spherical coordinates.\n\nMinimal version of the technique: [url]https://www.shadertoy.com/view/llGXWc[/url]",
  "INPUTS" : [
    {
      "NAME" : "iMouse",
      "TYPE" : "point2D"
