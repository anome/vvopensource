...
void main() {
	...
	float R = treshold / 2. + srcPixel.r * treshold > tmpColorA.r ? srcPixel.r : tmpColorA.r;
	float G = treshold / 2. + srcPixel.g * treshold > tmpColorA.g ? srcPixel.g : tmpColorA.g;
	float B = treshold / 2. + srcPixel.b * treshold > tmpColorA.b ? srcPixel.b : tmpColorA.b;
	//float R = 1.0 - srcPixel.r * treshold > tmpColorA.r ? srcPixel.r : tmpColorA.r;
	//float G = 1.0 - srcPixel.g * treshold > tmpColorA.g ? srcPixel.g : tmpColorA.g;
	//float B = 1.0 - srcPixel.b * treshold > tmpColorA.b ? srcPixel.b : tmpColorA.b;
	//float R = smoothstep(srcPixel.r, tmpColorA.r, treshold);
	//float G = smoothstep(srcPixel.g, tmpColorA.g, treshold);
	//float B = smoothstep(srcPixel.b, tmpColorA.b, treshold);
	...
	gl_FragColor = vec4(R, G, B, srcPixel.a);
}
