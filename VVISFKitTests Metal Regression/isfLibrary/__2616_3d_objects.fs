/*
{
  ...
  "DESCRIPTION" : "Automatically converted from https://www.shadertoy.com/view/MsjSzz by TDM.  smooth rasterize line and circle shapes\nand a little 3d pipeline :)",
  "INPUTS" : [
  		{
			"NAME": "linewidth",
			"TYPE": "float",
...
float WEIGHT = linewidth*2 / RENDERSIZE.x;
